...
table_fun_ml<- function(mldata,out_name_id,prs_col=(19:27)){
  ...
  write.csv(table1print, file=paste(output_dir,project_id,"_",t_title,"_","Table_CM_1_Demographics.csv",sep=""),row.names = TRUE, col.names = TRUE,quote=FALSE,sep=",")
  ...
  write.csv(table2print, paste(output_dir,project_id,"_",t_title,"_","Table_CM_1_meds_Demographics.csv",sep=""),row.names = TRUE, col.names = TRUE,quote=FALSE,sep = ",")
}
...
#Define models
modellist_table<-list(RF_fit,c50_fit,nb_fit)
#Define model names
modelnames<-c("RF_fit","c50_fit","nb_fit")
...
for (i in 1:length(modelnames)){
  ...
  #make dataframes
  model_strat_confuse_df<-create_table_df(testing_df,26,predict_train_fit)
  #plot tables
