...
svmGrid2 <-  expand.grid(degree = simplePoly[1], scale = simplePoly[2],C = simplePoly[3])
...
#Summary and Plot. 
ml_resample<-resamples(list(RF = RF_search,
                          RF_simple=RF_final,
                          GBM = gbmFit,
                          GBM_simple = gbm_final,
                          svmPoly = svmPolyFit2,
                          svmPoly_simple = svmPoly_final))
