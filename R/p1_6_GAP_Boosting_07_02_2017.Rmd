...
data_dir0 <-"./data/"
output_dir <-"./P1_Hypothesis_Free/output/"
figs_dir <-"./P1_Hypothesis_Free/figs/"


#Pre and post fixes.
project_name = "HF_boost"
project_id = "p1_6"
...
control <- trainControl(method="boot", number=300, savePredictions="all") ## Steve added sampling argument. READ!!
...
expressionRFE<-training_df_full[,c("Phenotype",opt_rfepredictors)]
...
##### Full adjustment
modellist<-ml_models_full
output_dir <-"./P2_Hypothesis_Driven/pheno_corrected/output/"
figs_dir <-"./P2_Hypothesis_Driven/pheno_corrected/figs/"
