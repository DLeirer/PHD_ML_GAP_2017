...
predict_train_fit<-predict(gbmFit, newdata = full_data)
confusionMatrix(predict_train_fit, full_data$Phenotype)
predict_fit
...
model_train_pred_panss<-merge(tpredictions,Panns_positive,by.x="row.names",by.y="sampleID")



names(model_train_pred_panss)
