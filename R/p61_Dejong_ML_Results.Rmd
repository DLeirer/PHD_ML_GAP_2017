...
#Save to file
write.csv(Split_1_metrics_full,paste(output_dir,project_id,project_name,Sub_prefix,"Split_1_Confusion_Matrix_metrics.csv",sep=""))



Dejong_results_ensemble2<-list() #empty list wrapper. 
confuse_split_1<-list() #empty list wrapper. 
for (i in 1:Number_of_Splits){
  #fold
  x=i
  #set top split ID
