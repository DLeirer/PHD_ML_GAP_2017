...
pMetric="Accuracy"
pMetric="Kappa"
Metric_grep = paste("*",pMetric,sep="")

#all points do this for Accuracy and Kappa
metric_results<-ml_resample$values[,grep(Metric_grep,colnames(ml_resample$values))]
...
ggplot(metric_plot2,
  ...
  coord_flip()+
  ggtitle(title)
ggsave(paste(figs_dir,title,".png",sep=""))
