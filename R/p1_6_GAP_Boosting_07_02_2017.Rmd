...
data_dir0 <-"./data/"
output_dir <-"./P1_Hypothesis_Free/p1_6_HF_boosting/output/"
figs_dir <-"./P1_Hypothesis_Free/p1_6_HF_boosting/figs/"
...
#Control for algorithms, Bootstrapping, 10k = ??? minutes 8 core.
...
opt_rfepredictors<-colnames(GX_DF_full_adj)[-c(1:27)]
